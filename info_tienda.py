...
def ingresar_datos_tienda(frame_contenido, mostrar_menu_principal):
    ...
    tk.Button(center_frame, text="Guardar datos", command=agregar_tienda_db, bg="#8e98f5").grid(row=5, column=0, columnspan=2, pady=10)
...
def actualizar_tienda(frame_contenido, mostrar_menu_principal):
    ...
    # Botón para agregar usuario
    tk.Button(center_frame, text="Actualizar Datos", command=actualiza_tienda_db, bg="#8e98f5").grid(row=3, column=0, columnspan=2, pady=10)
